...
void savestockInFile(string name, int prices);
...
void savecustomerInFile()
{
    ...
    {
        file << "\n"
             << customer_n_a[index] << " " << customer_p_a[index];
        index++;
    }
...
void display_customer()
{
    ...
    {
        cout << customer_n_a[count] << "\t\t\t" << customer_p_a[count] << endl;
        count++;
    }
}
void loadcustomer_bills()
...
void display_customers_bills()
{
    ...
    {
        cout << customer_n_a[count] << "\t\t\t" << customers_bills[count] << endl;
        count++;
    }
}
...
{
    fstream file;
    file.open("stocks_of_shop.txt", ios::app);
    file << " " << name << " " << prices << endl;
    cout << "Record saved into file " << endl;
    file.close();
}
void add_stock_in_array(string name, int price)
